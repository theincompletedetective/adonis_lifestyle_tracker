...
while True:
    ...
    try:
        ...
        if event == 'Add Food':
            ...
            handle_get_calories_eaten_for_weekday(values, db_path)

        elif event == 'Get Total Calories':
        ...
        elif event == 'Get Date for Weekday':
            handle_get_date_for_weekday(values, db_path)
